...
class MashupHandler {
    ReplaceSingleQuery(base64str, query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const mashupArray = new arrayUtils_1.ArrayReader(buffer);
            ...
            const newPackageBuffer = yield this.editSingleQueryPackage(packageOPC, "Query1", query);
            const packageSizeBuffer = arrayUtils_1.getInt32Buffer(newPackageBuffer.byteLength);
            const newMashup = arrayUtils_1.concatArrays(startArray, packageSizeBuffer, newPackageBuffer, endBuffer);
    ...
    editSingleQueryPackage(packageOPC, queryName, query) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const section1m = yield ((_a = packageZip.file("Formulas/Section1.m")) === null || _a === void 0 ? void 0 : _a.async("text"));
