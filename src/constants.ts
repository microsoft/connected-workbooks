...
export const QUERY_TABLE_NOT_FOUND = "No such query found in Query Table or Pivot Table found in given template";
export const QUERY_CONNECTION_NOT_FOUND = "No connection found for query";
export const FORMULA_NOT_FOUND = "Formula section wasn't found in template";
