...
describe("Workbook Manager tests", () => {
    ...
    test("test valid initial data in SheetsXML", async () => {
        ...
        const sheetsXmlString = await tableUtils.updateSheetsInitialData(defaultString, {columnMetadata: [{name: 'Column1', type: DataTypes.string}, {name: 'Column2', type: DataTypes.number} ], rows: [['1', '2']]});
    ...
    test("tests workbookXML contains initial data dimensions", async () => {
        ...
        const worksheetXml = await tableUtils.updateWorkbookInitialData(defaultString, {columnMetadata: [{name: 'Column1', type: DataTypes.string}, {name: 'Column2', type: DataTypes.number} ],
                rows: [['1', '2']]});
    ...
    test("tests Query Tables contain initial data", async () => {
        ...
        const queryTableXmlSheet = await tableUtils.updateQueryTablesInitialData(defaultString, {columnMetadata: [{name: 'Column1', type: DataTypes.string}, {name: 'Column2', type: DataTypes.number} ],
                rows: [['1', '2']]});
